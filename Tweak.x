...
- (void)viewDidLoad {
    ...
    self.features = @[@"وضع الشبح (إخفاء المشاهدة)", @"إخفاء يكتب الآن", @"حفظ السنابات والألبوم", @"سحب المحادثات تلقائياً", @"تزييف الستريك (999)", @"توثيق الحساب (نجمة)", @"تغيير الموقع (الرياض)", @"فك حظر الجهاز (IP)"];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (!isAuth) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"⚜️ GOLD SNAP V10 ⚜️" 
                                    message:@"أدخل كود التفعيل لتشغيل المنيو والمميزات" 
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"فتح المنيو" style:UIAlertActionStyleSecondary handler:^(UIAlertAction *action) {
            if(isAuth) {
